  ...
  return (
    <section className="px-4 sm:px-10 md:px-20 py-10 md:py-20 border-b border-gray-200">
      <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-10">
        ...
        {/* Profile Image */}
        <div className="order-1 md:order-2 w-36 h-36 sm:w-32 sm:h-32 md:w-56 md:h-56 md:right-20 relative overflow-hidden rounded-full border-2 border-black shadow-lg">
          <Image 
            src={Profile}
            alt="Profile image"
